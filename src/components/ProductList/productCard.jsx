...
function ProductCard(props) {
    return(
      <div className={salecard.conteiner}>
        ...
        <Image  className={salecard.popular} 
          src= {popular_img}
          alt = {"PopularProduct"} 
          width={84} 
          height={20}
        ...
        <Link className={salecard.img_product} href={`/product/`} passHref>
          <Image  className={salecard.image} 
          src={props.image} 
          alt = {props.nameRu} 
          width={300} 
          height={300}/>
        ...
        <div className={salecard.information}>
          ...
          <p className={salecard.word_barcode}>Штрихкод: 
             <span className={salecard.barcode}> {props.barcode}</span>
          </p>
          <p className={salecard.word_brand}>Бренд:
